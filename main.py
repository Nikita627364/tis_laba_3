...
# mysql+pymysql://isp_is_test:12345@192.168.25.23/isp_is_test
SQLALCHEMY_DATABASE_URL = "mysql+pymysql://isp_ir_Zhukov:12345@77.91.86.135/isp_ir_Zhukov"
...
class User(Base):
    ...
    username  = Column(String(50), index=True)  # Указываем длину для VARCHAR
